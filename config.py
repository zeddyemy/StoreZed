...
class Config:
    ...
    SERVER_NAME = "3dfc-105-112-31-9.ngrok-free.app" or os.getenv("FLASK_SERVER_NAME")
    ...
    # Domains
    API_DOMAIN_NAME = os.environ.get("API_DOMAIN_NAME") or "https://3dfc-105-112-31-9.ngrok-free.app"
    APP_DOMAIN_NAME = os.environ.get("APP_DOMAIN_NAME") or "https://3dfc-105-112-31-9.ngrok-free.app"
